    ...
    <div class="card">
      <div class="card-body ">
        ...
        <form action="" method="post">
          ...
          Nueva Contraseña <input type="password" id="passwordNueva" name="passwordNueva" pattern="[A-Za-z0-9!?-]{6,12}"><br><br>
          Otra Vez Nueva Contraseña <input type="password" id="passwordNueva2" name="passwordNueva2" pattern="[A-Za-z0-9!?-]{6,12}"><br><br>
